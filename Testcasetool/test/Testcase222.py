...
from PyQt5.QtGui import QDesktopServices, QCursor, QBrush, QColor, QIcon
from PyQt5.QtWidgets import QMainWindow, QApplication, QMessageBox, QFileDialog, QProgressDialog, QTableWidgetItem, \
    QComboBox, QMenu, QPushButton, QLineEdit, QWidget, QHBoxLayout
...
# from Models.CANconfig import Can
...
class UiMain(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        #  CAN通信配置
        self.pushButton_7.clicked.connect(self.refresh_connected_devices)
        ...
        # 重定向标准输出
        # sys.stdout = OutputRedirector(self.textBrowser_2)
