...
class MainWindow(QMainWindow,Ui_MainWindow):
    ...
    def addwidget(self):
        ...
        layout1.pushButton.clicked.connect(lambda: layout1.readMesseage(self.filename ))
    ...
    def closeEvent(self, event):
        reply = QtWidgets.QMessageBox.question(self, u'温馨提示', u'是否保存更改并退出?',QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No | QtWidgets.QMessageBox.Cancel)
        ...
        if reply == QtWidgets.QMessageBox.Yes:
            ...
            if self.tabWidget.currentIndex() == 0:
                ...
                layout1.readMesseage(self.filename)
